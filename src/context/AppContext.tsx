...
const translations = {
  tr: {
    ...
    'hero.badge': 'İstanbul Barosu',
    'hero.title': 'Hukuki Süreçlere Disiplinlerarası Bakış',
    'hero.description': 'Hukuk ve yazılım mühendisliği alanındaki akademik eğitimim doğrultusunda bilişim hukuku, dijital dönüşüm ve LegalTech alanlarında içerikler üretmekte ve hukuki süreçlere ilişkin bilgilendirme faaliyetleri yürütmekteyim.',
    'hero.cta.appointment': 'Randevu Talebi',
    'hero.cta.blog': 'Bilgi Merkezini Keşfet',
    'hero.experience': 'Çift Lisans Diploması',
    'hero.experience.sub': 'Hukuk & Yazılım Mühendisliği',
    
    'about.title': 'Hukuki Yaklaşımım',
    'about.desc1': 'Hukuk mesleğini; güncel mevzuatı, yüksek yargı kararlarını ve akademik çalışmaları sürekli takip etmeyi gerektiren dinamik bir alan olarak görüyorum. Mesleki gelişimimi yalnızca uygulama ile değil, bilimsel kaynaklar ve güncel içtihatlar doğrultusunda sürekli geliştirmeye önem veriyorum.',
    'about.desc2': 'Özel hukuk başta olmak üzere ceza hukuku, iş hukuku, ticaret hukuku, miras hukuku, borçlar hukuku, bilişim hukuku ve diğer hukuk dallarında güncel hukuki gelişmeleri düzenli olarak takip ediyor; her hukuki konunun kendi somut koşulları içerisinde değerlendirilmesi gerektiği anlayışıyla çalışmalarımı sürdürüyorum.',
    'about.point1': 'Müvekkillerle güvene dayalı iletişim anlayışı',
    'about.point2': 'Hukuki süreçlerin her aşamasında düzenli bilgilendirme',
    'about.point3': 'Açık, anlaşılır ve şeffaf iletişim yaklaşımı',
    'about.point4': 'Her hukuki sürece özenli ve titiz yaklaşım',
    
    'education.title': 'Eğitim Yolculuğu',
    'education.subtitle': 'Mesleki ve Akademik Birikim',
    ...
    'education.item3.desc': 'Hukuk Fakültesi ikincisi ve yazılım mühendisliğinden yüksek not ortalaması ile mezuniyet.',
    'education.item4.year': '2025',
    'education.item4.title': 'Yüksek Lisans & Baro Kaydı',
    'education.item4.desc': 'Özel Hukuk Yüksek Lisans programına başlangıç. İstanbul Barosu stajı ve ardından avukatlık ruhsatı alımı.',
    'education.item5.year': '2026',
    'education.item5.title': 'Serbest Avukatlık',
    'education.item5.desc': 'Serbest avukatlığa başlama ve ofis açılışı. Aktif CMK ve dosya takibi.',
    
    'stats.diplomas': '2 Lisans Diploması',
    'stats.masters': '1 Yüksek Lisans (Devam)',
    'stats.cmk': 'Aktif CMK Görevleri',
    'stats.projects': 'Dijital Hukuk Projeleri',
    'stats.content': 'Onlarca Hukuki İçerik',
    
    'practice.title': 'Çalışma Alanları',
    'practice.subtitle': 'Çalışma alanları kapsamında yürütülen hukuki faaliyetler',
  ...
  en: {
    ...
    'hero.badge': 'Istanbul Bar Association',
    'hero.title': 'An Interdisciplinary Approach to Legal Processes',
    'hero.description': 'In line with my academic education in law and software engineering, I produce content in IT law, digital transformation, and LegalTech, and carry out information activities regarding legal processes.',
    'hero.cta.appointment': 'Request Appointment',
    'hero.cta.blog': 'Explore Knowledge Center',
    'hero.experience': 'Double Bachelor Degree',
    'hero.experience.sub': 'Law & Software Engineering',
    
    'about.title': 'My Legal Approach',
    'about.desc1': 'I view the legal profession as a dynamic field that requires continuous tracking of current legislation, supreme court decisions, and academic studies. I place great importance on constantly developing my professional expertise not only through practice but also in line with scientific resources and current precedents.',
    'about.desc2': 'I regularly follow current legal developments, particularly in private law, criminal law, labor law, commercial law, inheritance law, law of obligations, IT law, and other legal branches, and continue my work with the understanding that every legal issue must be evaluated within its own concrete circumstances.',
    'about.point1': 'Trust-based communication with clients',
    'about.point2': 'Regular updates at every stage of legal processes',
    'about.point3': 'Clear, understandable, and transparent communication approach',
    'about.point4': 'Careful and meticulous approach to every legal process',
    
    'education.title': 'Education Journey',
    'education.subtitle': 'Professional & Academic Background',
    'education.item1.year': '2020',
    ...
    'education.item3.desc': 'Graduated as Faculty runner-up in Law and from software engineering with a high GPA.',
    'education.item4.year': '2025',
    'education.item4.title': 'Masters Degree & Bar Association Registry',
    'education.item4.desc': 'Started Private Law Master\'s degree. Istanbul Bar internship followed by obtaining the attorney license.',
    'education.item5.year': '2026',
    'education.item5.title': 'Sole Practice',
    'education.item5.desc': 'Starting sole practice and office opening. Active CMK duty and case tracking.',
    
    'stats.diplomas': '2 Bachelor Degrees',
    'stats.masters': '1 Masters Degree (Ongoing)',
    'stats.cmk': 'Active CMK Public Defenses',
    'stats.projects': 'Digital Law Projects',
    'stats.content': 'Dozens of Legal Articles',
    
    'practice.title': 'Practice Areas',
    'practice.subtitle': 'Legal activities carried out within our practice areas',
